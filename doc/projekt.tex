...
%==============================================================================
%\documentclass[]{fitthesis}[slovak,cprint] % bez zadání - pro začátek práce, aby nebyl problém s překladem
...
\projectinfo{
  ...
  title.cs={Watermarking jako ochrana dokumentů},  %nazev prace v cestine ci slovenstine (dle zadani) / thesis title in czech language (according to assignment)
  title.en={Watermarking as Document Protection}, %nazev prace v anglictine / thesis title in english
  %Autor / Author
  author={Patrik Segedy},   %cele jmeno a prijmeni autora / full name and surname of the author
  author.name={Patrik},   %jmeno autora (pro citaci) / author name (for reference) 
  author.surname={Segedy},   %prijmeni autora (pro citaci) / author surname (for reference) 
  ...
  %Skolitel / supervisor
  supervisor=Petr Hanáček, %cele jmeno a prijmeni skolitele / full name and surname of the supervisor
  supervisor.name={Petr},   %jmeno skolitele (pro citaci) / supervisor name (for reference) 
  supervisor.surname={Hanáček},   %prijmeni skolitele (pro citaci) / supervisor surname (for reference) 
  supervisor.title.p=Doc. Dr. Ing.,   %titul pred jmenem (nepovinne) / title before the name (optional)
...
\abstract[cs]{Táto práca sa zaoberá ochranou dokumentov pomocou digitálneho watermarkingu. Najprv sú prezentované vlastnosti vodoznakov. Potom nasledujú rôzne možnosti využitia tejto techniky. Ďalšia časť je venovaná rozboru súčasného vývoja v oblasti vodoznačenia, využitiu rôznych princípov vkladania vodoznaku pre rozličné typy multimediálnych dát. Následne je navrhnutý spôsob vkladania vodoznaku do statického obrazu, ktorý je neskôr implementovaný. Nakoniec je implementovaný algoritmus podrobený útokom za účelom poškodenia vodoznaku. Tento vodoznak je potom extrahovaný a je zhodnotená jeho podobnosť s vloženým vodoznakom.}
\abstract[en]{This thesis is dealing with document protection using a~digital watermarking. First, a~watermark characteristics are presented. Then, different usages of the watermarking are discussed. Next part of the thesis is dedicated to current development in watermarking field. It is aimed at various principles of watermark embedding into different multimedia types. Subsequently, a watermarking scheme for still images is proposed and implemented. Finally, the watermarking scheme undergoes attacks, which should damage embedded watermark. Attacked watermark is then extracted and compared to the embedded watermark.}

%Klicova slova (cesky, slovensky ci anglicky) / Keywords (in czech, slovak or english)
\keywords[cs]{vodoznačenie, vodoznak, QR rozklad, vkladanie vodoznaku, extrakcia vodoznaku, PSNR, NC}
\keywords[en]{watermarking, watermark, QR decomposition, watermark embedding, watermark extraction, PSNR, NC}

%Prohlaseni (u anglicky psane prace anglicky, u slovensky psane prace slovensky)
%Declaration (for thesis in english should be in english)
\declaration{Prehlasujem, že som túto bakalársku prácu vypracoval samostatne pod vedením pána Doc. Dr. Ing. Petra Hanáčka.
...
\acknowledgment{Rád by som sa poďakoval Doc. Dr. Ing. Petrovi Hanáčkovi za odborné vedenie bakalárskej práce a poskytnuté rady, ktoré mi pomohli s vypracovaním tohto zadania. Tiež sa chcem týmto poďakovať mojej rodine za neustálu podporu pri štúdiu.}
