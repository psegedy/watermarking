...
\abstract[en]{This thesis is dealing with document protection using digital watermarking. First, the watermark characteristics are presented. Then, different usages of watermarking are discussed. Next part of the thesis is dedicated to current development of watermarking. It is aimed at various principles of watermark embedding into different multimedia types. Subsequently, a watermarking scheme for still images is proposed and implemented. Finally, the watermarking scheme undergoes attacks, which should damage embedded watermark. Attacked watermark is then extracted and compared to the embedded watermark.}
...
\acknowledgment{Rád by som sa poďakoval Doc. Dr. Ing. Petrovi Hanáčkovi za odborné vedenie tejto bakalárskej práce a poskytnuté rady, ktoré mi pomohli s vypracovaním tejto práce.}
